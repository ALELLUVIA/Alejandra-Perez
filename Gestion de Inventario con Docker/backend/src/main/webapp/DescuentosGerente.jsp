...
<body>
    ...
    try {
        ...
        "appuser", 
        "apppass");
        String sql = "SELECT id_Promocion, porcentaje_De_Descuento, fecha_De_inicio, fecha_De_Fin, estado FROM Promociones";
...
%>
    ...
    <script>
        ...
        function showEditForm(id, porcentaje, fechaInicio, fechaFin, estado) {
        ...
        document.addEventListener("DOMContentLoaded", function() {
            const fields = ["porcentaje",  "fechaInicio", "fechaFin", "estado"];
